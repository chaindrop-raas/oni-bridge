...
function App() {
  ...
  // NB: `dynamicStyles` is a workaround to allow the use of environment
  // variables in Tailwind CSS styles. Vite supplies environment variables at
  // run time, but Tailwind CSS is compiled at build time. This workaround
  // injects the environment variables into the CSS at run time.
  const dynamicStyles = `
  :root {
    --color-accent: ${import.meta.env.VITE_BRIDGE_ACCENT_COLOR};
    --color-accent-dark: ${import.meta.env.VITE_BRIDGE_ACCENT_COLOR_DARK};
    --color-accent-fg: ${import.meta.env.VITE_BRIDGE_ACCENT_COLOR_FOREGROUND};
    --color-accent-fg-dark: ${
      import.meta.env.VITE_BRIDGE_ACCENT_COLOR_FOREGROUND_DARK
    };
    --color-base: ${import.meta.env.VITE_BRIDGE_BACKGROUND_COLOR};
    --color-base-dark: ${import.meta.env.VITE_BRIDGE_BACKGROUND_COLOR_DARK};
    --color-faded: ${import.meta.env.VITE_BRIDGE_FADED_COLOR};
    --color-faded-dark: ${import.meta.env.VITE_BRIDGE_FADED_COLOR_DARK};
    --color-foreground: ${import.meta.env.VITE_BRIDGE_FOREGROUND_COLOR};
    --color-foreground-dark: ${
      import.meta.env.VITE_BRIDGE_FOREGROUND_COLOR_DARK
    };
    --color-grouping: ${import.meta.env.VITE_BRIDGE_GROUPING_COLOR};
    --color-grouping-dark: ${import.meta.env.VITE_BRIDGE_GROUPING_COLOR_DARK};
    --color-subdued: ${import.meta.env.VITE_BRIDGE_SUBDUED_COLOR};
  }
  .dark {
    ...
    --color-grouping: var(--color-grouping-dark);
  }
  `;
      ...
      <div className="flex flex-col justify-between bg-base text-foreground min-h-svh">
        ...
        >
          ...
          <div className="flex flex-row gap-2">
            <button
              className="border-accent text-accent text-xs rounded-[4px] border w-full py-3"
              onClick={() => {
            ...
            <button
              ...
              className={clsx(
                "border-accent bg-accent text-accent-fg text-xs rounded-[4px] border w-full py-3",
